...
In Solve Equations with Fractions, we saw that there are two other ways to solve \(-r=2.\)We could multiply both sides by \(−1.\)
...
Notice that we could have divided both sides of the equation \(\frac{2}{3} x=18\) by \(\frac{2}{3}\) to isolate \(x.\) While this would work, multiplying by the reciprocal requires fewer steps.
...
*Fuel economy* Tania’s SUV gets half as many miles per gallon (mpg) as her husband’s hybrid car. The SUV gets \(18 mpg.\) Find the miles per gallons, \(m,\) of the hybrid car, by solving the equation \(\frac{1}{2} m=18.\)


*Fabric* The drill team used \(14\) yards of fabric to make flags for one-third of the members. Find how much fabric, \(f,\) they would need to make flags for the whole team by solving the equation \(\frac{1}{3} f=14.\)
