...
1 -1  ∣    6  \frac{1}{2}  ]  We want a 1 in row 1, column 1. This can be accomplished by interchanging row 1 and row 2.

R^{1} ↔ R^{2} → [  1 -1

2 3 ∣   \frac{1}{2}  6 ]  We now have a 1 as the first entry in row 1, column 1. Now let’s obtain a 0 in row 2, column 1. This can be accomplished by multiplying row 1 by -2, and then adding the result to row 2.

-2R^{1} + R^{2} = R^{2} → [  1 -1

0 5 ∣   \frac{1}{2}  5 ]  We only have one more step, to multiply row 2 by  \frac{1}{5} .

 \frac{1}{5}  R^{2} = R^{2} → [  1 -1

0 1 ∣   \frac{1}{2}  1 ]  Use back-substitution. The second row of the matrix represents y = 1. Back-substitute y = 1 into the first equation.

x - (1) =  \frac{1}{2} 

x =  \frac{3}{2}  The solution is the point (  3 __
...
4 2 ∣  1 6 ]  Obtain a 1 in row 1, column 1. This can be accomplished by multiplying the first row by  \frac{1}{2} .

 \frac{1}{2} R^{1} = R^{1} → [ 1  \frac{1}{2} 

4 2 ∣   \frac{1}{2}  6 ]  Next, we want a 0 in row 2, column 1. Multiply row 1 by -4 and add row 1 to row 2.

-4R^{1} + R^{2} = R^{2} → [ 1  \frac{1}{2} 

0 0 ∣   \frac{1}{2}  4 ]  The second row represents the equation 0 = 4. Therefore, the system is inconsistent and has no solution.
...
y = 3 -  \frac{3}{4} x So the solution to this system is ( x, 3 -  \frac{3}{4} x ) .
...
ref([A]) Evaluate. [    \frac{3}{5}    \frac{9}{5}    \frac{1}{5}  

0 1  \frac{13}{21}  - \frac{4}{7}  

   - 24 ___ 187   ]  →  x +  \frac{3}{5} y +  \frac{9}{5} z = - \frac{1}{5}  

y +  \frac{13}{21} z = - \frac{4}{7}   z = - 24 ___ 187   Using back-substitution, the solution is (  61 ___ ___ ___
...
0 0 - \frac{1}{3}   ∣    
 ...
 ]  The third row tells us - \frac{1}{T}he second row tells us y +  \frac{4}{3} z = 9,000. Substituting z = 6,000, we get

y +  \frac{4}{T}he first row tells us x + y + z = 10, 000. Substituting y = 1,000 and z = 6,000, we get
...
-1 ]  5x + 4y = 58 3x + 4y = -17 4x + y = 14 24. -4x - 3y = -2 3x - 5y = -13 10x + 6y = 5 26. 3x + 4y = 12 -6x - 8y = -24 29. 2x - y = 2 3x + 2y = \frac{17}{4} x -  \frac{3}{5} y = 4  \frac{1}{4} x +  \frac{2}{3} y = \frac{1}{4} x -  \frac{2}{3} y = -1  \frac{1}{2} x +  \frac{1}{3} y = 3 [ 
