...
x′ 2 \cancel -2x′ y′ + y′ 2 -  (x′ 2 - y′ 2) _  + x′ 2 \cancel + 2x′ y′ + y′ 2 - 30 = 0 Combine like terms.
...
cot(2\theta ) =  -9 ____ -12  =  \frac{3}{4} 

cot(2\theta ) =  \frac{3}{4}  =  adjacen\frac{t}{o}pposite  So the hypotenuse is

h = 5 Next, we find sin \theta  and cos \theta .

sin \theta  = \sqrt{___________}  1 - cos(2\theta ) __________   = \sqrt{1} -  \frac{3}{5}  _   = \sqrt{5} __ 5  -  \frac{3}{5}  _  = \sqrt{_________}  5 - 3 _____  ⋅ \frac{1}{2}   = \sqrt{___}
...
cos \theta  = \sqrt{___________}  1 + cos(2\theta ) __________   = \sqrt{1} +  \frac{3}{5}  _   = \sqrt{5} __ 5  +  \frac{3}{5}  _  = \sqrt{_________}  5 + 3 _____  ⋅ \frac{1}{2}   = \sqrt{___}
...
32x′ 2 - 32x′ y′ + 8y′ 2 - 24x′ 2 - 36x′ y′ + 24y′ 2 + 17x′ 2 + 68x′ y′ + 68y′ 2 = 100
 ...
 25 ____ ___ ___ 100  Write the equations with x′ and y′ in the standard form with respect to the new coordinate system.  x′ \frac{2}{4}  +  y′ \frac{2}{1}  = 1
...
Because cot(2\theta ) =  \frac{5}{12} , we can draw a reference triangle as in Figure 9.

cot(2\theta ) =  5 ___ 12  =  adjacen\frac{t}{o}pposite  Thus, the hypotenuse is

h = 13 Next, we find sin \theta  and cos \theta . We will use half-angle identities.

sin \theta  = \sqrt{___________}  1 - cos(2\theta ) __________   = \sqrt{1} -  \frac{5}{13}  _   = \sqrt{13} _ 13  -  \frac{5}{13}  _   = \sqrt{______}

 8 _____ 13  ⋅ \frac{1}{2}   =  2 _ \sqrt{13}  

cos \theta  = \sqrt{___________}  1 + cos(2\theta ) __________   = \sqrt{1} +  \frac{5}{13}  _   = \sqrt{13} _ 13  +  \frac{5}{13}  _   = \sqrt{______}

 18 ___ 13  ⋅ \frac{1}{2}   =  3 _ \sqrt{13}   Now we find x and y.
...
Multiply.
 ...
 x′ \frac{2}{6}  -  4y′ \frac{2}{15}  = 1 Divide by 390. _ 6  -  4y′ \frac{2}{I}dentifying Conics without Rotating Axes Now we have come full circle. How do we identify the type of conic described by an equation? What happens when the axes are rotated? Recall, the general form of a conic is
...
_ 4  +  y \frac{2}{1}  = 1, \theta  = 45°

_ 16  +  x \frac{2}{9}  = 1, \theta  = 45° 35. y 2 - x 2 = 1, \theta  = 45° 36. y =  x \frac{2}{2}  , \theta  = 30° 37. x = (y - 1)^{2}, \theta  = 30°

_ 9  +  y \frac{2}{4}  = 1, \theta  = 30°
...
r =  e\frac{p}{1} \pm  e cos \theta   For a conic with a focus at the origin, if the directrix is y = \pm  p, where p is a positive real number, and the eccentricity is a positive real number e, the conic has a polar equation

r =  e\frac{p}{1} \pm  e sin \theta  
...
(  \frac{3}{2}  ) 2 = (  \frac{3}{2}  )  \frac{2}{3}  p

3 = p Since e < 1, the conic is an ellipse. The eccentricity is e =  \frac{2}{3}  and the directrix is y = 3. b. Multiply the numerator and denominator by  \frac{1}{4} .

r =  _ 4 + 5 cos \theta   ⋅  (  \frac{1}{4}  )  _ (  \frac{1}{4}  )  

r =  _ 4  ) 

__

4(  \frac{1}{4}  )  + 5(  \frac{1}{4}  )  cos \theta  

r =  _ 1 +  \frac{5}{4}  cos \theta   Because cos \theta  is in the denominator, the directrix is x = p. Comparing to standard form, e =  \frac{5}{4} . Therefore, from the numerator,

3 = ep

3 =  \frac{5}{4}  p

(  \frac{4}{5}  ) 3 = (  \frac{4}{5}  )  \frac{5}{4}  p

 12 ___ 5  = p Since e > 1, the conic is a hyperbola. The eccentricity is e =  \frac{5}{4}  and the directrix is x =  12 ___ c. Multiply the numerator and denominator by  \frac{1}{2} .

r =  _ 2 - 2 sin \theta   ⋅  (  \frac{1}{2}  )  _ (  \frac{1}{2}  )  

r =  7(  \frac{1}{2}  ) 

__

2(  \frac{1}{2}  )  - 2(  \frac{1}{2}  )  sin \theta  

r =   \frac{7}{2}  _ 1 - sin \theta   Because sine is in the denominator, the directrix is y = -p. Comparing to standard form, e = 1. Therefore, from the numerator,

 \frac{7}{2}  = ep

 \frac{7}{2}  = (1)p

 \frac{7}{2}  = p Because e = 1, the conic is a parabola. The eccentricity is e = 1 and the directrix is y = - 7

**Try It #1**

Identify the conic with focus at the origin, the directrix, and the eccentricity for r =  ________ 3 - cos \theta  . Graphing the Polar Equations of Conics When graphing in Cartesian coordinates, each conic section has a unique equation. This is not the case when graphing in polar coordinates. We must use the eccentricity of a conic section to determine which type of curve to graph, and then determine its specific characteristics. The first step is to rewrite the conic in standard form as we have done in the previous example. In other words, we need to rewrite the equation so that the denominator begins with 1. This enables us to determine e and, therefore, the shape of the curve. The next step is to substitute values for \theta  and solve for r to plot a few key points. Setting \theta  equal to 0,  \p\frac{i}{2} , \pi , and  3\pi  ___ 2  provides the vertices so we can create a rough sketch of the graph.
...
r =  _ 3 + 3 cos \theta   =  5(  \frac{1}{3}  ) 

__

3(  \frac{1}{3}  )  + 3(  \frac{1}{3}  )  cos \theta  

r =   \frac{5}{3}  _ 1 + cos \theta   Because e = 1, we will graph a parabola with a focus at the origin. The function has a cos \theta , and there is an addition sign in the denominator, so the directrix is x = p.

 \frac{5}{3}  = ep

 \frac{5}{3}  = (1)p

 \frac{5}{3}  = p The directrix is x =  \frac{5}{3} . Plotting a few key points as in Table 1 will enable us to see the vertices. See Figure 3. A B C D \theta   \p\frac{i}{2}  \pi   3\pi  ___ 2  r =  _________ 3 + 3 cos \theta    5  5 undefined  5 A Directrix B F D r x = 5
...
r =  _ 2 - 3 sin \theta   =  8(  \frac{1}{2}  ) 

__

2(  \frac{1}{2}  )  - 3(  \frac{1}{2}  )  sin \theta  

r =  _ 1 -  \frac{3}{2}  cos \theta   Because e =  \frac{3}{2} , e > 1, so we will graph a hyperbola with a focus at the origin. The function has a sin \theta  term and there is a subtraction sign in the denominator, so the directrix is y = -p.
...
4(  \frac{2}{3}  )  = p
 ...
 \frac{8}{3}  = p The directrix is y = - \frac{8}{3} . Plotting a few key points as in Table 2 will enable us to see the vertices. See Figure 5. A B C D \theta   \p\frac{i}{2}  \pi   3\pi  ___ 2  r =  _________ 2 - 3 sin \theta   -8  \frac{8}{A} C D B r
...
5(  \frac{1}{5}  )  - 4(  \frac{1}{5}  )  cos \theta  

r =  _ 1 -  \frac{4}{5}  sin \theta   Because e =  \frac{4}{5} , e < 1, so we will graph an ellipse with a focus at the origin. The function has a cos \theta , and there is a subtraction sign in the denominator, so the directrix is x = -p.
...
2(  \frac{5}{4}  )  = p
 ...
 \frac{5}{2}  = p The directrix is x = - \frac{5}{2} . Plotting a few key points as in Table 3 will enable us to see the vertices. See Figure 6. A B C D \theta   \p\frac{i}{2}  \pi   3\pi  ___ 2  r =  _________ 5 - 4 cos \theta    10 ___ D C B A r x = -5 Directrix
...
Finding the Polar Form of a Horizontal Conic Given a Focus at the Origin and the Eccentricity and Directrix Find the polar form of a conic given a focus at the origin, e =  \frac{3}{5} , and directrix x = 4.
...
r =  ep _________ 1 + e cos \theta   and e =  \frac{3}{5}  and |4| = 4 = p.

Therefore,

r =  (  \frac{3}{5}  ) (4) ___________ 1 +  \frac{3}{5}  cos \theta  

r =   \frac{12}{5}  ___________ 1 +  \frac{3}{5}  cos \theta  

r =   \frac{12}{5}  _______________

1 (  \frac{5}{5}  ) +  \frac{3}{5}  cos \theta  

r =   \frac{12}{5}  ____________  \frac{5}{5}  +  \frac{3}{5}  cos \theta  

r =  \frac{12}{5}  ⋅  _________ 5 + 3 cos \theta  
